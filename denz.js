...
const vcard1 = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n'
            + 'FN:Cortes PIRES\n'
            + 'ORG:Co Owner PIRES 𝙱𝙾𝚃;\n'
            + 'TEL;type=CELL;type=VOICE;waid=+556996103915:+55 69 9610-3915\n'
            + 'END:VCARD'

prefix = "!"
name = "PIRES-bot"
rdaftar = "OBRIGADO POR SE REGISTAR PARA SER UM USUÁRIO DO PIRES-bot :)"
rmenu = "Oi amigo PIRES 👋🏻 NÃO SE ESQUEÇA NAO PAGUE POR BOTS:)"
...
async function starts() {
	...
	denz.on('connecting', () => {
		start('2', 'conectando com Pires ❤️...')
	})
	denz.on('open', () => {
...
ᴅɪɢɪᴛᴇ ${prefix}daftar ᴘᴀʀᴀ ᴄᴏᴍᴇᴄᴀʀ ᴀ ᴜsᴀʀ  ʙᴏᴛ`
	...
	denz.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '*⏳ ᴇsᴘᴇʀᴇ ᴛᴏᴍᴇ  ᴜᴍ tome uma agua ᴇɴǫᴜᴀɴᴛᴏ ᴠᴏᴜ ᴛᴇ ᴇɴᴄᴀʀᴄᴀʀ ᴅᴇ ᴘᴇ...*',
				success: '*sᴜᴄᴇssᴏ...*',
				error: {
			...
			const ownerNumber = ["556996103915@s.whatsapp.net","6285277188863@s.whatsapp.net","6287894610286@s.whatsapp.net"] // owner number ubah aja
...
case 'igpost': 				
				...
				if (!isUrl(args[0]) && !args[0].includes('www.instagram.com')) return reply('este não é o url do instagram do anjim')
				ige = body.slice(8)
